...
<div class="container flex flex-col gap-4 p-4">
  <div class="header flex flex-row">
    <div><h3>Create your smart contract now &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h3></div>
    <div class="tab overflow-hidden">
      <OverflowMenu>
        <button class:selected={lang === 'solidity'} on:click={() => lang = 'solidity'}>
          Solidity
        </button>
        <button class:selected={lang === 'cairo'} on:click={() => lang = 'cairo'}>
          Cairo
        </button>
      ...
      <!-- create a dropdown with the above options -->
      <!-- <Dropdown let:active>
        <button class="action-button" class:active slot="button">
          {tab}
        </button>

        <button class="download-option" on:click={() => tab = 'ERC20'}>
          ERC20
        </button>

        <button class="download-option" on:click={() => tab = 'ERC721'}>
          ERC721
        </button>
      </Dropdown> -->
    </div>
